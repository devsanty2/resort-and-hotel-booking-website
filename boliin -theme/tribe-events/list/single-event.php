	...
	<div class="tribe-event-right clearfix">
		<div class="content-inner">
			...
			<div class="entry-summary">
				<?php echo boliin_limit_words($excerpt_words, get_the_excerpt(), get_the_content()); ?>
			</div>

			</div>

			<div class="event-action">
				<a class="btn-theme" href="<?php echo esc_url( tribe_get_event_link() ); ?>"><span><?php echo esc_html__('Join Event', 'boliin') ?></span></a>
			</div>
	</div>
</div>