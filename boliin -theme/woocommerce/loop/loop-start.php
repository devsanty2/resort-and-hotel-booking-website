 ...
 */
   ...
   $columns_lg = boliin_get_option('product_columns_lg', $std_lg);
   $columns_md = boliin_get_option('product_columns_md', $std_md);
   $columns_sm = boliin_get_option('product_columns_sm', $std_sm);
   $columns_xs = boliin_get_option('product_columns_xs', $std_xs);
?>
