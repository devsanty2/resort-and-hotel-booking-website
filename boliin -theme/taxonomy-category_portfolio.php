 ...
 */
	...
	$columns_lg = boliin_get_option('portfolio_columns_lg', '4');
	$columns_md = boliin_get_option('portfolio_columns_md', '3');
	$columns_sm = boliin_get_option('portfolio_columns_sm', '2');
	$columns_xs = boliin_get_option('portfolio_columns_xs', '1');
