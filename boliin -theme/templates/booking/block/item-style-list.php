      ...
      <div class="booking-list__image">
         ...
         <?php 
            ...
            if($discount || $featured){
               echo '<div class="booking-list__labels item-labels">';
                  if($discount){
                     echo '<span class="booking-list__label booking-list__discount">' . esc_html($discount) . '% ' . esc_html__( 'off', 'boliin' ) . '</span>';
                  }
                  if($featured){
                     echo '<span class="booking-list__label booking-list__featured">' . esc_html__( 'Featured', 'boliin' ) . '</span>';
                  }
               echo '</div>';   
            }
         ?>

         <?php if(class_exists('Boliin_Addons_Wishlist_Ajax')){ 
        ...
        <div class="booking-list__content">
            <div class="booking-list__content-inner">
               ...
               <div class="booking-list__content-top">
                  ...
                  if($video || $images): ?>
                     <div class="booking-list__media booking__media">
                        ...
                        <?php if($video){ ?>
                           <a class="booking-list__video popup-video" href="<?php echo esc_url($video) ?>"><i class="bicon-video-camera"></i></a>
                        <?php } ?>
               ...
               <div class="booking-list__price booking__price">
                  ...
                  <?php } ?>
                  <label>/&nbsp; <?php echo esc_html__('night', 'boliin'); ?></label>
               </div>
            </div>   
               ...
               <div class="booking-list__meta-left">
                  <?php
                     ...
                     if ($area){
                        ...
                        echo '<span class="booking-list__item-area booking-one__item-meta">' . esc_html($area) . '</span>';
                     }
                  ?>
               ...
               <div class="booking-list__meta-right">
                  <?php
                     ...
                     if ($guests){
                        ...
                        echo '<span class="booking-list__item-user booking-one__item-meta">' . $guests . '</span>';
                     }
                  ?>
               </div>   
            </div>
