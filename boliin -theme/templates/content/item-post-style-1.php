<?php 
   ...
   if ( in_array( 'category', get_object_taxonomies(get_post_type()) ) ){
      $cat_html = '<span class="cat-links">' . get_the_category_list( _x( ", ", "Used between list items, there is a space after the comma.", "boliin" ) ) . '</span>';
   }
      ...
      <div class="post-one__wrap">
         ...
         <div class="post-one__content">
            ...
            <div class="post-one__content-inner">
               ...
               ?>
               <a class="post-one__read-more btn-black" href="<?php echo esc_url( get_permalink() ) ?>">
