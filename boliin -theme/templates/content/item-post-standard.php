<?php 
   ...
   $thumbnail = (isset($thumbnail_size) && $thumbnail_size) ? $thumbnail_size : 'boliin_medium';
      ...
      <div class="<?php echo esc_attr($content_classes) ?>">
         <div class="post-standard__content-inner">
            ...
            <div class="post-standard__read-more">
               <a class="btn-border-theme" href="<?php echo esc_url( get_permalink() ) ?>"><?php echo esc_html__('Read more', 'boliin'); ?></a>
            </div>
         </div>
